...
function CountdownPopup({onRedirect} : CountdownPopupProps) {
  const [countdown, setCountdown] = useState(3);
  const Images = ["/imageone.svg", "imgtwo.svg", "imgthree.svg"]
...
function page() {
  ...
  function handleRedirect(x:number){
  ...
  let button_arr = [handlePlay, handleCreateRoom, handleJoin]
  ...
  return (
    ...
    <div className="flex flex-col justify-around h-screen relative">
      ...
      <div className="flex flex-col justify-center p-3 gap-3">
        ...
        <Button
          onClick={() => (username ? handleRedirect(0) : "")}
          className={
        ...
        <div className="flex justify-between">
          ...
          <div className="w-3/6 px-1">
            <Modal
              ...
              enable={username ? true : false}
              actions={
                <button className="btn btn-primary" onClick={()=>{handleRedirect(2)}}>
                  Join
                </button>
              }
            >
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-between items-center">
                ...
                <input
                  ...
                  max="1"
                  step="0.01"
                  value={changeVolume.state}
                  onChange={(e)=>changeVolume.change(Number(e.target.value))}/>
            </div>
            <div className="flex justify-between items-center">
            <label className={`${font2.className} absolute mt-20 p-0`}>
